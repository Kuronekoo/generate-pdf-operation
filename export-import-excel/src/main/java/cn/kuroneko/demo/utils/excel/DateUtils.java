...
public class DateUtils {
	...
	public static String getToday(){
		...
		return dateTimeFormatter.format(LocalDateTime.now())+" 00:00:00";
	}
	public static String getTomorrow(){
		DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		LocalDateTime localDateTime = LocalDateTime.now().plusDays(1);
		return dateTimeFormatter.format(localDateTime)+" 00:00:00";
	}
	/**
	 * 获得当前日期时间
	 * <p>
	...
	public static Date[] getStartAndEndDateForCurMonth() {
		Integer year = year();
		Integer month = month();
	...
	//日期-小时
	public static Date desHour(Date date,Integer hour)
	{
		Calendar ca=Calendar.getInstance();
		ca.setTime(date);
		ca.add(Calendar.HOUR_OF_DAY, -hour);
